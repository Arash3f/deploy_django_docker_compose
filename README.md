# How to deploy django project with docker compose

In this repository we deploy 3 type of django project with docker compose .
...
- Django + Sqlite3 ([see](https://github.com/ "see"))

>Simple django project with sqlite for database

- Django + PostgreSQL ([see](https://github.com/ "see"))

>Simple django project with postgreSQL for database

- Django + Gunicorn + PostgreSQL + Nginx ([see](https://github.com/ "see"))
